...
readTime: 5
next: 'building-ai-agents-with-langchain-part-2'
---
...
<Callout variant="info" showIcon>
	To follow this series, you would need a good understanding of JavaScript and some basic knowledge
	of TypeScript.
</Callout>
...
<Callout variant="warning">
	You would need an [OpenAI](https://platform.openai.com/api-keys) and [Tavily](https://tavily.com)
	API keys to run the following code.
</Callout>
