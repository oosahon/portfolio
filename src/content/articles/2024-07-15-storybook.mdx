...
<Callout variant="info" showIcon>
	Decorators are applied to a story in this order of precedence: story level, component level, and
	global. That is, when decorators are defined both story and component levels, the Story level
	would be applied.
</Callout>
